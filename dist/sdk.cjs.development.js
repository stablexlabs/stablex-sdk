...
var FACTORY_ADDRESS = '0x18be671d4221E9C7f2642A0182F3b3Fb7913Cd3b';
var INIT_CODE_HASH = '0x2d0322aaee46b4dcc562f117d4184f8e2b4bf8e4029a8be62dd3ae7dee5c0245';
...
var _9994 = /*#__PURE__*/JSBI.BigInt(9994);
var SolidityType;
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'STAX-LP', 'StableXSwap LPs');
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.raw, _9994);
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), _9994);
